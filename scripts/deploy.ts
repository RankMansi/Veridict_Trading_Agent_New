 ...
 *
 * HACKATHON / JUDGING: Do not use this for the ERC-8004 challenge — use the shared
 * Sepolia addresses in SHARED_CONTRACTS.md and `.env.example`. Leaderboards read those
 * contracts only. This script is for local development, tests, or forks.
 *
 ...
 *
 * After running: copy the printed addresses into your .env (or use shared addresses instead).
 */
